...
const EditEmployeeForm = ({closeEdit, loadEmployee,employee}) => {
  ...
  const [formData, setFormData] = useState({
       id: employee.id,
    personalDetails: {
      id: employee.personalDetails.id,
      ...
      currentAddressLine1: employee.personalDetails.currentAddressLine1,
      currentAddressLine2: employee.personalDetails.currentAddressLine2,
      currentCity: employee.personalDetails.currentCity,
      currentPincode: employee.personalDetails.currentPincode,
      permanentAddressLine1: employee.personalDetails.permanentAddressLine1,
      permanentAddressLine2: employee.personalDetails.permanentAddressLine2,
      permanentCity: employee.personalDetails.permanentCity,
      permanentPincode: employee.personalDetails.permanentPincode,
      mobile: employee.personalDetails.mobile,
      personalEmail: employee.personalDetails.personalEmail,
      emergencyContactName: employee.personalDetails.emergencyContactName,
      emergencyContactMobile: employee.personalDetails.emergencyContactMobile,
      sameAsCurrentAddress: false,
    },
    professionalDetails: {
      id: employee.professionalDetails.id,
      employmentCode: employee.professionalDetails.employmentCode,
      companyEmail: employee.professionalDetails.companyEmail,
      officePhone: employee.professionalDetails.officePhone,
      officeCity: employee.professionalDetails.officeCity,
      officeAddress: employee.professionalDetails.officeAddress,
      reportingManager: employee.professionalDetails.reportingManager,
      hrName: employee.professionalDetails.hrName,
      dateOfJoining: employee.professionalDetails.dateOfJoining,
      employmentHistory: employee.professionalDetails.employmentHistory,
    },
    financeDetails: {
      id: employee.financeDetails.id,
      panCard: employee.financeDetails.panCard,
      aadharCard: employee.financeDetails.aadharCard,
      bankName: employee.financeDetails.bankName,
      branch: employee.financeDetails.branch,
      ifscCode:employee.financeDetails.ifscCode,
      ctc:employee.financeDetails.ctc,
    },
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        const response = await axios.put(`http://localhost:8080/admin/employee/${formData.id}`, formData);
  ...
  <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
    <div className="bg-white w-1/2 max-w-lg h-3/4 max-h-screen overflow-y-auto p-8 relative rounded-lg">
      <div className="flex justify-between items-center">
        ...
        <button className="text-gray-500 hover:text-gray-700" onClick={closeEdit}>X</button>
      </div>
...
// const PersonalDetails = ({ formData, handleInputChange, handleSameAddressCheckbox }) => (
// <div className="">
//   <h3 className="text-lg font-semibold mb-4">Personal Details</h3>
//   <div className="grid grid-cols-2 gap-4">
//     <div>
//       <label className="block mb-2">Full Name:</label>
//       <input type="text" name="fullName" value={formData.fullName} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Date of Birth:</label>
//       <input type="date" name="dateOfBirth" value={formData.dateOfBirth} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Age:</label>
//       <input type="text" name="age" value={formData.age} onChange={handleInputChange} disabled={true} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Mobile:</label>
//       <input type="text" name="mobile" value={formData.mobile} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Personal Email:</label>
//       <input type="email" name="personalEmail" value={formData.personalEmail} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Emergency Contact Name:</label>
//       <input type="text" name="emergencyContactName" value={formData.emergencyContactName} onChange={handleInputChange} required className="border p-2 w-full"/>
//     </div>
//     <div>
//       <label className="block mb-2">Emergency Contact Mobile:</label>
//       <input type="text" name="emergencyContactMobile" value={formData.emergencyContactMobile} onChange={handleInputChange} required className="border p-2 w-full"/>
//     </div>
//   </div>
//   <h4 className="mt-4 font-semibold">Current Address</h4>
//   <div className="grid grid-cols-2 gap-4">
//     <div>
//       <label className="block mb-2">Current Address Line 1:</label>
//       <input type="text" name="currentAddressLine1" value={formData.currentAddressLine1} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Current Address Line 2:</label>
//       <input type="text" name="currentAddressLine2" value={formData.currentAddressLine2} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Current City:</label>
//       <input type="text" name="currentCity" value={formData.currentCity} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Current Pincode:</label>
//       <input type="text" name="currentPincode" value={formData.currentPincode} onChange={handleInputChange} required className="border p-2 w-full" />
//     </div>
//   </div>
//   <label className="inline-flex items-center mt-4">
//     <input type="checkbox" checked={formData.sameAsCurrentAddress} onChange={handleSameAddressCheckbox} className="mr-2" />
...
//     <div>
//       <label className="block mb-2">Permanent Address Line 1:</label>
//       <input type="text" name="permanentAddressLine1" value={formData.permanentAddressLine1} onChange={handleInputChange} disabled={formData.sameAsCurrentAddress} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Permanent Address Line 2:</label>
//       <input type="text" name="permanentAddressLine2" value={formData.permanentAddressLine2} onChange={handleInputChange} disabled={formData.sameAsCurrentAddress} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Permanent City:</label>
//       <input type="text" name="permanentCity" value={formData.permanentCity} onChange={handleInputChange} disabled={formData.sameAsCurrentAddress} required className="border p-2 w-full" />
//     </div>
//     <div>
//       <label className="block mb-2">Permanent Pincode:</label>
//       <input type="text" name="permanentPincode" value={formData.permanentPincode} onChange={handleInputChange} disabled={formData.sameAsCurrentAddress} required className="border p-2 w-full" />
//     </div>
//   </div>
// </div>
// );

// const ProfessionalDetails = ({ formData, handleInputChange }) => (
// <div>
//   <h3 className="text-lg font-semibold mb-4">Professional Details</h3>
//   <div className="grid grid-cols-2 gap-4">
...
//   <div>
//   <label className="block mb-2">Employee Code:</label>
//   <input type="text" name="employmentCode" value={formData.employmentCode} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">Company Email:</label>
//   <input type="email" name="companyEmail" value={formData.companyEmail} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">Office Phone:</label>
//   <input type="text" name="officePhone" value={formData.officePhone} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">Office Address:</label>
//   <input type="text" name="officeAddress" value={formData.officeAddress} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">Office City:</label>
//   <input type="text" name="officeCity" value={formData.officeCity} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">Reporting Manager:</label>
//   <input type="text" name="reportingManager" value={formData.reportingManager} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">HR Name:</label>
//   <input type="text" name="hrName" value={formData.hrName} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">Date of Joining:</label>
//   <input type="date" name="dateOfJoining" value={formData.dateOfJoining} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">Employment History:</label>
//   <textarea name="employmentHistory" value={formData.employmentHistory} onChange={handleInputChange} className="border p-2 w-full"></textarea>
...
// const FinanceDetails = ({ formData, handleInputChange }) => (
// <div>
//   <h3 className="text-lg font-semibold mb-4">Finance Details</h3>
//   <div className="grid grid-cols-2 gap-4">
//    <div>
//   <label className="block mb-2">Pancard:</label>
//   <input type="text" name="panCard" value={formData.panCard} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">Aadhar Number:</label>
//   <input type="text" name="aadharCard" value={formData.aadharCard} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">Bank Name:</label>
//   <input type="text" name="bankName" value={formData.bankName} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">Branch:</label>
//   <input type="text" name="branch" value={formData.branch} onChange={handleInputChange} required className="border p-2 w-full"/>
//   </div>
//   <div>
//   <label className="block mb-2">IFSC Code:</label>
//   <input type="text" name="ifscCode" value={formData.ifscCode} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   <div>
//   <label className="block mb-2">CTC:</label>
//   <input type="number" name="ctc" value={formData.ctc} onChange={handleInputChange} required className="border p-2 w-full" />
//   </div>
//   </div>
// </div>
// );
...
//   const handleSubmit = async (e) => {
//     e.preventDefault();  
//     await axios.put(`http://localhost:8080/admin/employee/${formData.id}`, formData)
//     .then(response => {
//         console.log(response)
//         alert('Employee Updated successfully');
//         closeEdit();
